...
### Installation Steps
1. install calibration in this framework
2. auto save and re-calibrate the calibration result
3. add an automation script to run the calibration
4. Eye in hand calibration
...
4. Test franka api use tcp_test.py
```bash
...
Now, you can see the aruco marker in the rqt_image_view. Press any key to continue, press q to quit.
