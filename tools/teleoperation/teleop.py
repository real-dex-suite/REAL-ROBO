import hydra
import time
from holodex.processes import get_tactile_stream_processes, get_detector_processes, get_teleop_process, get_tactile_visualizer_process
import multiprocessing

@hydra.main(version_base = '1.2', config_path='../../configs', config_name='teleop_franka_pico')
def main(configs):    
