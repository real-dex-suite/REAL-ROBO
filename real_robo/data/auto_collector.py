...
# when we move the robot, the wrapper already starts a thread to publish the franka state


from real_robo.robots.franka_env_wrapper import FrankaEnvWrapper
from real_robo.device.camera import RealSenseCamera
...
class AutoFrankaCollector(object):
    def __init__(
        ...
        rospy.init_node('data_extractor', disable_signals = True)  # Replace
