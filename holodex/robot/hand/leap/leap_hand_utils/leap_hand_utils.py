...
def LEAPsim_limits(type = "regular"):
    if type == "regular":
        ...
        sim_max = np.array([1.047,    2.23,  1.3,  2.042,  1.047,   2.23,  1.3,  2.042,  1.047,   2.23,  1.3,  2.042,  2.094,  2.443, 1.90,  1.88]) # change 1.885 to 1.3 for temporal fix collision due to tactile can collide with part
