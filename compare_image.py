...
class CompareDifference:
    ...
    def load_images(self, folder_path, prefix):
        ...
        for i in range(1, self.num_images, self.interval):
            if folder_path == self.folder1_path:
    ...
    def create_diff_grid(self, images1, images2):
        ...
        for i in range(num_images):
            ...
            overlaid_img = cv2.addWeighted(img1, 1.0, img2, self.alpha, 0)
            ...
            grid_img[
                ...
                :,
            ] = np.hstack((overlaid_img, diff_img))
    ...
    def run_comparison(self):
        ...
        if images1 and images2:
            ...
            cv2.imwrite("difference_grid.png", diff_grid)
            # cv2.imshow("Difference Grid", diff_grid)
            cv2.waitKey(0)
...
def main():
    folder1_path = "/home/agibot/Projects/Real-Robo/extracted_data/filtered/images/demonstration_1/camera_1_color_image"
    folder2_path = "/home/agibot/Projects/Real-Robo/test_image/camera_1_color_image"
    comparer = CompareDifference(
        folder1_path,
        folder2_path,
        prefix1="",
        prefix2="replay_image_",
        num_images=145,
        interval=2,
        alpha=0.7,
        target_size=(256, 256),
